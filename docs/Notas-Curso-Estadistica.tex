...
\href{https://www.ece.iastate.edu/~namrata/EE527_Spring08/l4c.pdf}{Para más detalles}
...
\StringTok{    }\NormalTok{theta1, }\DataTypeTok{color =} \OperatorTok{~}\NormalTok{step, }\DataTypeTok{alpha =} \FloatTok{0.5}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{gf_point}\NormalTok{(theta2 }\OperatorTok{~}\StringTok{ }
\StringTok{    }\NormalTok{theta1, }\DataTypeTok{color =} \OperatorTok{~}\NormalTok{step, }\DataTypeTok{alpha =} \FloatTok{0.5}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\includegraphics{Notas-Curso-Estadistica_files/figure-latex/unnamed-chunk-131-4.pdf}
...
\includegraphics{Notas-Curso-Estadistica_files/figure-latex/unnamed-chunk-132-2.pdf}
...
\includegraphics{Notas-Curso-Estadistica_files/figure-latex/unnamed-chunk-132-3.pdf}
...
\includegraphics{Notas-Curso-Estadistica_files/figure-latex/unnamed-chunk-135-3.pdf}
...
\NormalTok{Gibbs }\OperatorTok{%>%}\StringTok{ }\KeywordTok{filter}\NormalTok{(step }\OperatorTok{<}\StringTok{ }\DecValTok{500}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{gf_path}\NormalTok{(theta2 }\OperatorTok{~}\StringTok{ }\NormalTok{theta1, }
    \DataTypeTok{color =} \OperatorTok{~}\NormalTok{step, }\DataTypeTok{alpha =} \FloatTok{0.5}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{gf_point}\NormalTok{(theta2 }\OperatorTok{~}\StringTok{ }
\StringTok{    }\NormalTok{theta1, }\DataTypeTok{color =} \OperatorTok{~}\NormalTok{step, }\DataTypeTok{alpha =} \FloatTok{0.5}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\includegraphics{Notas-Curso-Estadistica_files/figure-latex/unnamed-chunk-135-4.pdf}
...
\includegraphics{Notas-Curso-Estadistica_files/figure-latex/unnamed-chunk-136-2.pdf}
...
\includegraphics{Notas-Curso-Estadistica_files/figure-latex/unnamed-chunk-136-3.pdf}
...
\includegraphics{Notas-Curso-Estadistica_files/figure-latex/unnamed-chunk-136-4.pdf}
